...
function initWorksScroll() {
  ...
  if (track) {
    // Only touch the DOM if we actually have data to replace it with —
    // otherwise keep the static cards already in the HTML.
    ...
    // else: no WORKS_DATA loaded — leave the static cards already in the HTML as-is.
  }
